...
''' Fluid Properties - H2
    ...
    If you investigate the plot of Cp vs. Temperature you will see a dip at 778 K.  
...
class H2(BaseSpecies):
    def __init__(self):
        ...
        self.Cp_vs_T = np.array([[ 277.777,  333.333,  388.888,  444.444,  500.000,  555.555,
                                   666.667,  777.777,  888.888, 1000.000, 1111.111, 1222.222,
                                  1333.333, 1444.444, 1555.555],
