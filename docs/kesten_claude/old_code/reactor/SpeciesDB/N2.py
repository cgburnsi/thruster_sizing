...
''' Fluid Properties - N2
    ...
    # SPECIFIC HEAT INFORMATION
        ...
        CFTBL2  = [0.2485, 0.2495, 0.2524, 0.2569, 0.2624, 0.2681, 0.2738, 0.2790, 
                   0.2836, 0.2878, 0.2914, 0.2946, 0.2974, 0.2998, 0.3019]
...
class N2(BaseSpecies):
    def __init__(self):
        super().__init__()
        self.name       = "Nitrogen"                        # [str] Common Name for this species
        self.formula    = "N2"                              # [str] Chemical formula for species
        ...
        # Specific Heat Data (Temperature = [K], Specific Heat = [kJ/kg-K])
        self.Cp_vs_T = np.array([[300.0, 400.0, 500.0, 600.0, 700.0, 800.0, 900.0, 1000.0, 1100.0, 1200.0, 1300.0, 1400.0, 1500.0, 1600.0, 1700.0],
                                 [1.0404, 1.0446, 1.0568, 1.0756, 1.0986, 1.1225, 1.1464, 1.1681, 1.1874, 1.205, 1.22, 1.2334, 1.2452, 1.2552, 1.264]])
